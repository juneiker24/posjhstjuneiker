...
<div id="config_wrapper" class="col-sm-12">
	...
	<div class="container">
		<div class="row">
			...
			<p style="min-height:9.9em;">Usuario Setup</p> 
			<p>Permisos</p></strong>
			</div> 
			<div class="col-sm-8" id="issuetemplate" align="left"><br>
				<?php echo $this->lang->line('config_ospos_info') . ':'; ?>
				<?php echo $this->config->item('application_version'); ?> - <?php echo substr($this->config->item('commit_sha1'), 0, 9); ?><br>
...
<div align="center">
		<a class="copy" data-clipboard-action="copy" data-clipboard-target="#issuetemplate">Copy Info</a> | <a href="https://github.com" target="_blank"> <?= $this->lang->line('config_report_an_issue'); ?></a>
		<script>
