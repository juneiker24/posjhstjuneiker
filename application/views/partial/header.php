...
<head>
	...
	<title><?php echo $this->config->item('company') . ' | ' . $this->lang->line('common_powered_by') . ' JHST ' . $this->config->item('application_version') ?></title>
	...
	<?php } ?>
		...
		<script type="text/javascript" src="dist/opensourcepos.min.js?rel=8e8799a892"></script>
		...
		<div class="navbar navbar-default" role="navigation">
			<div class="container">
				<div class="navbar-header">
					...
					<a class="navbar-brand hidden-sm" href="<?php echo site_url(); ?>">JHST SISTEMA</a>
				</div>
